...
})({"bQFwi":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1d2236afe61e3d6e";
"use strict";
...
},{}],"6DLyi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _dlx = require("./DLX");
var _dlxDefault = parcelHelpers.interopDefault(_dlx);
const enforceValidity = (dlx, puz, solution)=>{
    if (!solution.length) return puz;
    const valid = dlx.validPuzzle(puz);
    if (valid) return puz;
    let minSize = 2916;
    let minIndex = -1;
    for(let i = 0; i < 81; i++)if (puz[i] === 0) {
        puz[i] = solution[i];
...
const solve = (dlx, puzzle)=>{
    const solution = dlx.solvePuzzle(puzzle);
    return solution;
};
const checkValidity = (dlx, puzzle)=>{
    ...
    const possibleValues = new Array(81);
    for(let i = 0; i < 81; i++){
    ...
    dlx.uncoverRows(nodes);
    return {
        isValid: valid ? true : valid,
        possibleValues
    };
};
self.onmessage = ({ data: { id, cmd, puzzle, solution } })=>{
    const dlx = new (0, _dlxDefault.default)();
    switch(cmd){
        case 0:
            return self.postMessage({
                id,
                solution: solve(dlx, puzzle)
            });
        case 1:
            return self.postMessage({
                id,
                puzzle: enforceValidity(dlx, puzzle, solution ?? new Array(81).fill(0))
            });
        case 2:
            return self.postMessage({
                id,
                ...checkValidity(dlx, puzzle)
            });
    }
};

},{"./DLX":"hvfhM","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}],"hvfhM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dlh = require("./DLH");
var _dlhDefault = parcelHelpers.interopDefault(_dlh);
var _dln = require("./DLN");
var _dlnDefault = parcelHelpers.interopDefault(_dln);
...
class DLX {
    ...
    constructor(){
        ...
        this.root = new (0, _dlhDefault.default)(0);
        const columns = [
            this.root
        ];
        for(let i = 1; i < 324; i++){
            const column = new (0, _dlhDefault.default)(i);
        ...
        for(let i = 0; i < 729; i++){
            ...
            const allFilledNode = new (0, _dlnDefault.default)(i, columns[r * 9 + c]);
            const rowsUniqueNode = new (0, _dlnDefault.default)(i, columns[r * 9 + v + 81]);
            const columnsUniqueNode = new (0, _dlnDefault.default)(i, columns[c * 9 + v + 162]);
            const boxsUniqueNode = new (0, _dlnDefault.default)(i, columns[b * 9 + v + 243]);
...
},{"./DLH":"513ZL","./DLN":"1qsIl","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}],"513ZL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _node = require("./Node");
var _nodeDefault = parcelHelpers.interopDefault(_node);
class DLH extends (0, _nodeDefault.default) {
    constructor(column){
        super(column), this.size = 0;
    }
    disconnect() {
        this.size--;
...
},{"./Node":"edSxH","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}],"edSxH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"1qsIl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _node = require("./Node");
var _nodeDefault = parcelHelpers.interopDefault(_node);
class DLN extends (0, _nodeDefault.default) {
    ...
    *up() {
        yield* (0, _node.walk)(this, (n)=>n.topNode);
    }
    *down() {
        yield* (0, _node.walk)(this, (n)=>n.bottomNode);
    }
    disconnect() {
...
},{"./Node":"edSxH","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}]},["bQFwi","6DLyi"], "6DLyi", "parcelRequire94c2")

//# sourceMappingURL=SW.e61e3d6e.js.map
